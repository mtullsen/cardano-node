...
scriptHashFromPlutusDebug (PlutusDebugV1 _ _ s _ _) =
  hashScript $ PlutusScript PlutusScriptV1 (PlutusScriptSerialised s)
scriptHashFromPlutusDebug (PlutusDebugV2 _ _ s _ _) =
  hashScript $ PlutusScript PlutusScriptV1 (PlutusScriptSerialised s)
...
displayPlutusDebug pr pdb =
  ...
  where
    ...
    encodedPDB = BS.unpack . B64.encode . serialize' $ pdb
